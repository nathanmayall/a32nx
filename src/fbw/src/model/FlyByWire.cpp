...
void FlyByWireModelClass::step()
{
  ...
  if (FlyByWire_U.in.data.autopilot_custom_on == 0.0) {
    rtb_Sum1_d5 = look1_binlxpw(rtb_LimiteriH, FlyByWire_P.uDLookupTable1_bp01Data, FlyByWire_P.uDLookupTable1_tableData,
      3U);
    u1 = FlyByWire_U.in.data.V_ias_kn / FlyByWire_U.in.data.V_mach * look1_binlxpw(rtb_LimiteriH,
      FlyByWire_P.uDLookupTable2_bp01Data, FlyByWire_P.uDLookupTable2_tableData, 3U);
    if (rtb_Sum1_d5 < u1) {
      u1 = rtb_Sum1_d5;
    }

    if (FlyByWire_U.in.data.V_ias_kn > u1) {
  ...
  if (rtb_Y_gj > FlyByWire_P.Saturation3_UpperSat_e) {
    rtb_Gain_i = FlyByWire_P.Saturation3_UpperSat_e;
  } else if (rtb_Y_gj < FlyByWire_P.Saturation3_LowerSat_c) {
    rtb_Gain_i = FlyByWire_P.Saturation3_LowerSat_c;
  } else {
    rtb_Gain_i = rtb_Y_gj;
  }
  ...
  rtb_LimiteriH = FlyByWire_P.Gain1_Gain_j * rtb_Y * (FlyByWire_P.Gain_Gain_dc * FlyByWire_P.Vm_currentms_Value) +
  ...
  rtb_Sum1_d5 += FlyByWire_P.Gain1_Gain_m * rtb_BusAssignment_sim_input_delta_xi_pos;
  if (rtb_Sum1_d5 > FlyByWire_P.Saturation_UpperSat_n) {
    rtb_Sum1_d5 = FlyByWire_P.Saturation_UpperSat_n;
  } else if (rtb_Sum1_d5 < FlyByWire_P.Saturation_LowerSat_o) {
  ...
  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Switch_Threshold_p) {
    ...
    rtb_LimiteriH = FlyByWire_P.Gain3_Gain_k * rtb_Y_f + FlyByWire_DWork.Delay_DSTATE_ho;
    if (rtb_LimiteriH > FlyByWire_P.Saturation3_UpperSat) {
      rtb_LimiteriH = FlyByWire_P.Saturation3_UpperSat;
    } else if (rtb_LimiteriH < FlyByWire_P.Saturation3_LowerSat) {
      rtb_LimiteriH = FlyByWire_P.Saturation3_LowerSat;
    }
  }

  FlyByWire_RateLimiter(rtb_LimiteriH, FlyByWire_P.RateLimiterVariableTs2_up_bi, FlyByWire_P.RateLimiterVariableTs2_lo_a,
  ...
  rtb_BusAssignment_e_roll_law_normal_xi_deg = ((rtb_Y_d - rtb_GainPhi) * FlyByWire_P.Gain2_Gain_i +
    FlyByWire_P.PreControlGain_Gain * rtb_Gain1_b) + FlyByWire_P.Gain1_Gain_mg * rtb_BusAssignment_a_sim_data_pk_deg_s *
  ...
  rtb_Limiterxi1 = FlyByWire_P.Constant_Value_i - rtb_Gain1_b;
  ...
  FlyByWire_LagFilter(rtb_Sum1_d5, FlyByWire_P.LagFilter_C1_c, FlyByWire_U.in.time.dt, &rtb_Y_d,
  ...
  rtb_Gain1_b = ((rtb_Limiterxi1 * rtb_Y_gj + rtb_LimiteriH) * rtb_Gain1_b + (FlyByWire_P.Constant_Value_l - rtb_Gain1_b)
