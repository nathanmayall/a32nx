...
void FlyByWireModelClass::step()
{
  ...
  if (FlyByWire_U.in.data.autopilot_custom_on == 0.0) {
    rtb_Sum1_d5 = look1_binlxpw(rtb_LimiteriH, FlyByWire_P.uDLookupTable1_bp01Data, FlyByWire_P.uDLookupTable1_tableData,
      3U);
    L_xi = FlyByWire_U.in.data.V_ias_kn / FlyByWire_U.in.data.V_mach * look1_binlxpw(rtb_LimiteriH,
      FlyByWire_P.uDLookupTable2_bp01Data, FlyByWire_P.uDLookupTable2_tableData, 3U);
    if (rtb_Sum1_d5 < L_xi) {
      L_xi = rtb_Sum1_d5;
    }

    if (FlyByWire_U.in.data.V_ias_kn > L_xi) {
  ...
  L_xi = std::abs(FlyByWire_B.flare_Theta_c_rate_deg_s) * FlyByWire_U.in.time.dt;
  if (rtb_Sum1_d5 < L_xi) {
    L_xi = rtb_Sum1_d5;
  }
  ...
  L_xi = FlyByWire_P.RateLimiterVariableTs3_up_m * FlyByWire_U.in.time.dt;
  if (rtb_Sum1_d5 < L_xi) {
    L_xi = rtb_Sum1_d5;
  }
  ...
  L_xi = 5.0 - (FlyByWire_U.in.data.V_ias_kn - (FlyByWire_U.in.data.VLS_kn + 5.0)) * 0.25;
  if (0.0 > L_xi) {
    L_xi = 0.0;
  }
  ...
  FlyByWire_RateLimiter(static_cast<real_T>(rtb_nz_limit_lo_g) - L_xi, FlyByWire_P.RateLimiterVariableTs6_up,
  ...
  L_xi = FlyByWire_P.RateLimiterVariableTs4_up * FlyByWire_U.in.time.dt;
  if (rtb_Sum1_d5 < L_xi) {
    L_xi = rtb_Sum1_d5;
  }
  ...
  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Switch1_Threshold_ke) {
    ...
    if (FlyByWire_DWork.sProtActive > FlyByWire_P.Switch2_Threshold) {
      ...
      if (rtb_Loaddemand > FlyByWire_P.Saturation8_UpperSat) {
        rtb_Limiterxi1 = FlyByWire_P.Saturation8_UpperSat;
      } else if (rtb_Loaddemand < FlyByWire_P.Saturation8_LowerSat) {
        rtb_Limiterxi1 = FlyByWire_P.Saturation8_LowerSat;
      } else {
      ...
      rtb_Limiterxi1 += rtb_Sum1_d5;
    } else {
      rtb_Limiterxi1 = FlyByWire_P.Constant1_Value;
    }

    rtb_Loaddemand = (FlyByWire_P.Constant_Value_k - rtb_Y_o) * rtb_Loaddemand + rtb_Limiterxi1 * rtb_Y_o;
    if (rtb_in_flare > FlyByWire_P.Switch_Threshold) {
      rtb_Limiterxi1 = (FlyByWire_DWork.Delay_DSTATE_dq - rtb_GainTheta) * FlyByWire_P.Gain_Gain;
      if (rtb_Limiterxi1 > FlyByWire_P.Saturation_UpperSat) {
        rtb_Limiterxi1 = FlyByWire_P.Saturation_UpperSat;
      } else if (rtb_Limiterxi1 < FlyByWire_P.Saturation_LowerSat) {
        rtb_Limiterxi1 = FlyByWire_P.Saturation_LowerSat;
      }
    } else {
      rtb_Limiterxi1 = FlyByWire_P.Constant_Value_m;
    }
    ...
    rtb_Gain1_b = rtb_Y_o + rtb_Limiterxi1;
  }
  ...
  rtb_y_i = (rtb_BusAssignment_c_sim_data_speeds_aoa_alpha_max_deg - rtb_Switch) * rtb_Y_k;
  ...
  L_xi = (std::abs(rtb_GainPhi) - 3.0) / 6.0;
  if (0.0 > L_xi) {
    L_xi = 0.0;
  }
  ...
  FlyByWire_WashoutFilter(L_xi, FlyByWire_P.WashoutFilter_C1, FlyByWire_U.in.time.dt, &rtb_Y_k,
    &FlyByWire_DWork.sf_WashoutFilter);
  rtb_Limiterxi = (rtb_y_i - rtb_Limiterxi) - rtb_Y_k;
  ...
  L_xi = FlyByWire_P.RateLimiterVariableTs5_up * FlyByWire_U.in.time.dt;
  if (rtb_Sum1_d5 < L_xi) {
    L_xi = rtb_Sum1_d5;
  }
  ...
  rtb_Y_k = ((rtb_Loaddemand - FlyByWire_DWork.Delay_DSTATE_ca) / FlyByWire_U.in.time.dt * FlyByWire_P.Gain3_Gain_l +
             rtb_Limiterxi * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.PLUT_bp01Data,
              FlyByWire_P.PLUT_tableData, 1U)) + (rtb_Divide1 - FlyByWire_DWork.Delay_DSTATE_jv) /
    FlyByWire_U.in.time.dt;
  ...
  if (rtb_Y_k > FlyByWire_P.Saturation_UpperSat_j) {
    rtb_Y_k = FlyByWire_P.Saturation_UpperSat_j;
  } else if (rtb_Y_k < FlyByWire_P.Saturation_LowerSat_c) {
    rtb_Y_k = FlyByWire_P.Saturation_LowerSat_c;
  }

  rtb_Limiterxi = (FlyByWire_P.Constant_Value_p - rtb_Limiterxi1) * rtb_Y_k + rtb_Sum1_d5 * rtb_Limiterxi1;
  ...
  L_xi = rtb_ManualSwitch * FlyByWire_U.in.time.dt;
  if (rtb_Sum1_d5 < L_xi) {
    L_xi = rtb_Sum1_d5;
  }
  ...
  rtb_Limiterxi1 = rtb_Sum1_d5 * 0.5144;
  rtb_Sum1_d5 = rtb_Limiterxi1 * rtb_Limiterxi1 * 0.6125;
  rtb_Limiterxi = rtb_Sum1_d5 / rtb_Limiterxi1 * 122.0 * 320.40999999999997 * -2.078 / 1.376155E+6;
  L_xi = rtb_Sum1_d5 * 122.0 * 17.9 * -0.291 / 1.376155E+6;
  k_phi = -(-rtb_Limiterxi * -rtb_Limiterxi) / L_xi;
  ...
  rtb_Sum1_d5 = (rtb_Y_k - std::sin(FlyByWire_P.Gain1_Gain_br * rtb_LimiteriH) * FlyByWire_P.Constant2_Value_li * std::
                 ...
                 FlyByWire_P.Gain_Gain_cd) * look1_binlxpw(FlyByWire_U.in.data.V_ias_kn,
  ...
  rtb_Y_k *= look1_binlxpw(FlyByWire_U.in.data.V_ias_kn, FlyByWire_P.ScheduledGain1_BreakpointsForDimension1,
    FlyByWire_P.ScheduledGain1_Table, 6U);
  ...
  if (rtb_Y_k > FlyByWire_P.Saturation2_UpperSat_e) {
    rtb_Y_k = FlyByWire_P.Saturation2_UpperSat_e;
  } else if (rtb_Y_k < FlyByWire_P.Saturation2_LowerSat_gp) {
    rtb_Y_k = FlyByWire_P.Saturation2_LowerSat_gp;
  }

  rtb_Limiterxi1 = rtb_BusAssignment_p_roll_data_computed_in_flight_gain * rtb_Sum1_d5 + rtb_Y_k;
  FlyByWire_Y.out.roll.law_normal.pk_c_deg_s = rtb_Gain1_b;
  FlyByWire_Y.out.roll.law_normal.Phi_c_deg = rtb_LimiteriH;
  k_phi = (-(2.0 * -rtb_Limiterxi + rtb_Limiterxi) / L_xi * rtb_BusAssignment_a_sim_data_pk_deg_s + k_phi * rtb_GainPhi)
    + -k_phi * rtb_LimiteriH;
  ...
  L_xi = FlyByWire_P.Constant_Value_i - rtb_Gain1_b;
  ...
  FlyByWire_LagFilter(FlyByWire_U.in.data.autopilot_custom_Beta_c_deg + rtb_Product_e, FlyByWire_P.LagFilter1_C1_f,
                      FlyByWire_U.in.time.dt, &rtb_Y_k, &FlyByWire_DWork.sf_LagFilter_k);
  ...
  rtb_Gain1_b = ((L_xi * rtb_Y_k + rtb_LimiteriH) * rtb_Gain1_b + (FlyByWire_P.Constant_Value_l - rtb_Gain1_b) *
  ...
  L_xi = FlyByWire_P.Constant_Value_b * FlyByWire_U.in.time.dt;
  if (rtb_Sum1_d5 < L_xi) {
    L_xi = rtb_Sum1_d5;
  }
  ...
  rtb_Y_i = (FlyByWire_P.Constant_Value_l1 - rtb_Gain1_b) * rtb_BusAssignment_p_roll_data_computed_delta_xi_deg + k_phi *
    rtb_Gain1_b;
  ...
  FlyByWire_Y.out.roll.law_normal.xi_deg = k_phi;
